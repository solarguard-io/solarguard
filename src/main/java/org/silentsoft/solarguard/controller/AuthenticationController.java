...
public class AuthenticationController {
    ...
    public ResponseEntity<?> createLoginToken(@RequestBody LoginVO loginVO, HttpServletRequest request, HttpServletResponse response) {
        try {
            LoginTokenEntity loginTokenEntity = authenticationService.createLoginToken(loginVO.getUsername(), loginVO.getPassword(), extractIpAddressFromRequest(request), loginVO.getDeviceName());
    ...
    private String extractIpAddressFromRequest(HttpServletRequest request) {
